...
export async function getUrls(): Promise<Url[]> {
  try {
    ...
    const response = await authFetch("https://mai-2-33v6.onrender.com/urls")
...
export async function deleteUrl(id: string): Promise<boolean> {
  try {
    const response = await authFetch(`https://mai-2-33v6.onrender.com/urls/${id}`, {
      method: "DELETE",
    })
...
export async function getPdfs(): Promise<Pdf[]> {
  try {
    const response = await authFetch("https://mai-2-33v6.onrender.com/pdfs")
...
export async function deletePdf(id: string): Promise<boolean> {
  try {
    const response = await authFetch(`https://mai-2-33v6.onrender.com/pdfs/${id}`, {
      method: "DELETE",
    })
...
export async function getDashboardStats(): Promise<DashboardStats> {
  try {
    const response = await authFetch("https://mai-2-33v6.onrender.com/stats")
...
export async function getRecentActivity(): Promise<RecentActivity> {
  try {
    const response = await authFetch("https://mai-2-33v6.onrender.com/activity")
